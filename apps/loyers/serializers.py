...
class LoyerSerializer(serializers.ModelSerializer):
    ...
    def get_statut_display(self, obj): return obj.get_statut_display_custom()
    class Meta:
        model = Loyer
        fields = '__all__'
...
class BordereauSerializer(serializers.ModelSerializer):
    ...
    def get_photo_url(self, obj):
        ...
        if obj.photo and req: return req.build_absolute_uri(obj.photo.url)
        return obj.photo.url if obj.photo else None
    def get_locataire_nom(self, obj): return obj.locataire.nom_prenom
    def get_loyer_libelle(self, obj): return obj.loyer.libelle if obj.loyer else None
    class Meta:
        model = Bordereau
        fields = '__all__'
